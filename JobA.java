...
public class JobA  implements Serializable{
	...
	private percentageResource percentage_MEM;
	private percentageResource percentage_CPU;
	...
	public void set_percentage(int memCPU,percentageResource xPercentage){
		//1 Mem, 0 CPU
		if (memCPU==1){
	...
	public void setCPUusage() {  //this behaves according to the percentage of the resource
		this.CPUusage = this.computeCPUUse(this.get_percentage(0));
	}



	public void setMEMusage() { //this behaves according to the percentage of the resource
		this.MEMusage = this.computeMemUse(this.get_percentage(1));
	}
	...
	protected int computeMemUse(percentageResource X){
	...
	protected int computeCPUUse(percentageResource X){
